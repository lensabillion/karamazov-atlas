...
const IDENTIFICATIONS: PlateIdentification[] = [
  ...
  { id: 31, title: 'An old man seated, a younger man behind', status: 'unidentified',
    description: 'An old man with a long white beard sits with his hands folded; a younger man stands behind his chair. First read as Grigory and Marfa, but enlarged the standing figure looks like a man. Samsonov with his son (VIII.1) is another possibility. Neither is confirmed.', people: [] },
