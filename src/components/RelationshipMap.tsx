        ...
        <svg ref={svgRef} viewBox={`0 0 ${W} ${H}`} role="img"
          ...
          {ZONES.map((z) => (
            <text key={z.label} x={z.x} y={z.y} textAnchor="middle"
              style={{ font: '700 11px EB Garamond, Georgia, serif', letterSpacing: '0.12em' }}
                ...
                {showLabel && (
                  <>
                    ...
                    <text x={mx} y={my} textAnchor="middle" dominantBaseline="middle"
                      style={{ font: '400 11px EB Garamond, Georgia, serif' }}
                      fill={
            ...
            return (
              <g key={p.id} opacity={lit(p.id) ? 1 : 0.2}
                ...
                <text x={p.x} y={p.y - (on ? 22 : 18)} textAnchor="middle"
                  style={{ font: `${on ? 700 : 400} 13px EB Garamond, Georgia, serif` }}
                  fill="var(--ink)">
                  {p.name}
                </text>
              </g>
