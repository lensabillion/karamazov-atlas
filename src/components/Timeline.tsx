              ...
              <g key={`band-${s.id}`}>
                ...
                {wrap(s.label.toUpperCase(), 18).map((ln, j) => (
                  <text key={j} x={GUTTER - 16} y={b.y + 14 + j * 13} textAnchor="end"
                    style={{ font: '600 11px EB Garamond, Georgia, serif', letterSpacing: '0.06em' }}
                    fill="var(--ink-3)">
                    {ln}
                  </text>
                ))}
                <text x={GUTTER - 16}
                  ...
                  style={{ font: '400 10px EB Garamond, Georgia, serif' }} fill="var(--ink-3)">
            ...
            return (
              <g key={`h-${lane.id}`}>
                ...
                <text x={x + 24} y={HEADER - 26}
                  style={{ font: '600 13px EB Garamond, Georgia, serif' }} fill="var(--ink)">
                  {lane.name}
                </text>
              </g>
            );
              ...
              <g key={i} className="hit"
                ...
                {lines.map((ln, j) => (
                  <text key={j} x={x + 10} y={y + 18 + j * 13}
                    style={{ font: `${span.key ? 600 : 400} 11px EB Garamond, Georgia, serif` }}
                ...
                {span.ends && (
                  <>
                    ...
                    <text x={x + 10} y={y + h + 14}
                      style={{ font: '600 10px EB Garamond, Georgia, serif', letterSpacing: '0.06em' }}
                      fill="var(--teal-deep)">
                      ENDS HERE
                    </text>
                  </>
